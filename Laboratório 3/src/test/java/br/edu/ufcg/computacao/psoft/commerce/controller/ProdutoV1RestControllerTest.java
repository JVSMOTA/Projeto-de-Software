...
class ProdutoV1RestControllerTest {
    ...
    class ValidacaoDeEntradasAtualizacao {
        ...
        void quandoAtualizarProdutoComDadosValidos() throws Exception {
            ...
            Produto produtoAdicionado = produtoRepository.save(modelMapper.map(produtoPutDTO, Produto.class));
    ...
    class ValidacaoDeEntradasCodigoBarra {
        ...
        void quandoAtualizarCodigoBarrasComDadosValidos() throws Exception {
            ...
            Produto produtoAdicionado = produtoRepository.save(modelMapper.map(produtoPatchCodigoBarrasDTO, Produto.class));
    ...
    class ValidacaoDeSaidas {
        ...
        void quandoExcluirProdutoComDadosValidos() throws Exception {
            ...
            produtoPostDTO = ProdutoPostDTO.builder()
                    ...
                    .fabricante("Samsung")
                    .build();
            Produto produtoAdicionado = produtoRepository.save(modelMapper.map(produtoPostDTO, Produto.class));
    ...
    class ValidacaoDeBuscas {
        ...
        void quandoBuscarProdutoComDadosValidos() throws Exception {
            ...
            produtoGetOneDTO = ProdutoGetOneDTO.builder()
                    ...
                    .fabricante("Samsung")
                    .build();
            Produto produtoAdicionado = produtoRepository.save(modelMapper.map(produtoGetOneDTO, Produto.class));
    ...
    class ValidacaoDeListagem {
        ...
        void quandoListarTodosOsLogradouros() throws Exception {
            ...
            produtoGetAllDTO = ProdutoGetAllDTO.builder()
                    ...
                    .build();
            Produto produtoAdicionado1 = produtoRepository.save(modelMapper.map(produtoGetAllDTO, Produto.class));
            ...
            produtoGetAllDTO = ProdutoGetAllDTO.builder()
                    ...
                    .build();
            Produto produtoAdicionado2 = produtoRepository.save(modelMapper.map(produtoGetAllDTO, Produto.class));
            ...
            produtoGetAllDTO = ProdutoGetAllDTO.builder()
                    ...
                    .build();
            Produto produtoAdicionado3 = produtoRepository.save(modelMapper.map(produtoGetAllDTO, Produto.class));
