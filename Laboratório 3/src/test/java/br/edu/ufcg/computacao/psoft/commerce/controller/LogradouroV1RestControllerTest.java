...
class LogradouroV1RestControllerTest {
    ...
    class ValidacaoDeEntradasAtualizacao {
        ...
        void quandoAtualizarLogradouroComDadosValidos() throws Exception {
            ...
            logradouroPostPutDTO = LogradouroPostPutDTO.builder()
                    ...
                    .cep("58580-000")
                    .build();
            Logradouro logradouroAdicionado = logradouroRepository.save(modelMapper.map(logradouroPostPutDTO, Logradouro.class));
    ...
    class ValidacaoDeEntradasTipoLogradouro {
        ...
        void quandoAtualizarTipoLogradouroComDadosValidos() throws Exception {
            ...
            Logradouro logradouroAdicionado = logradouroRepository.save(modelMapper.map(logradouroPatchTipoDTO, Logradouro.class));
        ...
        void quandoAtualizarNomeLogradouroComDadosValidos() throws Exception {
            ...
            Logradouro logradouroAdicionado = logradouroRepository.save(modelMapper.map(logradouroPatchNomeDTO, Logradouro.class));
    ...
    class ValidacaoDeBuscas {
        ...
        void quandoBuscarLogradouroComDadosValidos() throws Exception {
            ...
            logradouroGetOneDTO = LogradouroGetOneDTO.builder()
                    ...
                    .cep("58580-000")
                    .build();
            Logradouro logradouroAdicionado = logradouroRepository.save(modelMapper.map(logradouroGetOneDTO, Logradouro.class));
    ...
    class ValidacaoDeListagem {
        ...
        void quandoListarTodosOsLogradouros() throws Exception {
            ...
            logradouroGetAllDTO = LogradouroGetAllDTO.builder()
                    ...
                    .cep("58580-0001 ")
                    .build();
            Logradouro logradouroAdicionado1 = logradouroRepository.save(modelMapper.map(logradouroGetAllDTO, Logradouro.class));
            ...
            logradouroGetAllDTO = LogradouroGetAllDTO.builder()
                    ...
                    .cep("58580-000 2")
                    .build();
            Logradouro logradouroAdicionado2 = logradouroRepository.save(modelMapper.map(logradouroGetAllDTO, Logradouro.class));
            ...
            logradouroGetAllDTO = LogradouroGetAllDTO.builder()
                    ...
                    .cep("58580-000 3")
                    .build();
            Logradouro logradouroAdicionado3 = logradouroRepository.save(modelMapper.map(logradouroGetAllDTO, Logradouro.class));
