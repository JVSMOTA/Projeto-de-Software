...
class PessoaV1RestControllerTest {
    ...
    class ValidacaoDeEntradasAtualizacao {
        ...
        void quandoAtualizarPessoaComDadosValidos() throws Exception {
            ...
            pessoaPutDTO = PessoaPutDTO.builder()
                    ...
                    .profissao("Desenvolvedor Backend")
                    .build();
            Pessoa pessoaAdicionada = pessoaRepository.add(modelMapper.map(pessoaPutDTO, Pessoa.class));
    ...
    class ValidacaoDeEntradasEmail {
        ...
        void quandoAtualizarEmailPessoaComDadosValidos() throws Exception {
            ...
            Pessoa pessoaAdicionada = pessoaRepository.add(modelMapper.map(pessoaPatchEmailDTO, Pessoa.class));
    ...
    class ValidacaoDeSaidas {
        ...
        void quandoExcluirPessoaComDadosValidos() throws Exception {
            ...
            pessoaPostDTO = PessoaPostDTO.builder()
                    ...
                    .profissao("Desenvolvedor Backend")
                    .build();
            Pessoa pessoaAdicionada = pessoaRepository.add(modelMapper.map(pessoaPostDTO, Pessoa.class));
    ...
    class ValidacaoDeBuscas {
        ...
        void quandoBuscarPessoaComDadosValidos() throws Exception {
            ...
            pessoaGetOneDTO = PessoaGetOneDTO.builder()
                    ...
                    .profissao("Desenvolvedor Backend")
                    .build();
            Pessoa pessoaAdicionada = pessoaRepository.add(modelMapper.map(pessoaGetOneDTO, Pessoa.class));
    ...
    class ValidacaoDeListagem {
        ...
        void quandoListarTodosAsPessoas() throws Exception {
            ...
            pessoaGetAllDTO = PessoaGetAllDTO.builder()
                    ...
                    .build();
            Pessoa pessoaAdicionada1 = pessoaRepository.add(modelMapper.map(pessoaGetAllDTO, Pessoa.class));
            ...
            pessoaGetAllDTO = PessoaGetAllDTO.builder()
                    ...
                    .build();
            Pessoa pessoaAdicionada2 = pessoaRepository.add(modelMapper.map(pessoaGetAllDTO, Pessoa.class));
            ...
            pessoaGetAllDTO = PessoaGetAllDTO.builder()
                    ...
                    .build();
            Pessoa pessoaAdicionada3 = pessoaRepository.add(modelMapper.map(pessoaGetAllDTO, Pessoa.class));
